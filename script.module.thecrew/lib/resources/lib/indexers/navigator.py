...
class navigator:
    def root(self):
        ...
        if not control.setting('navi.add_addons') == True:
        ...
        #if not control.setting('navi.personal.list') == '0':
...
#        if not yes: return
    ...
    def add_addons(self):
        if not control.setting('navi.titan') == True:
        ...
        if not control.setting('navi.base') == True:
            self.addDirectoryItem(90201, 'base', 'base.png', 'DefaultMovies.png')
        if not control.setting('navi.waste') == True:
